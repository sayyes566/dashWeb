...
<!------
    ...
    <body>
        <!--  <div id="reload_bar1">refresh</div>-->
       <!-- -->
      <div id="container_YieldTrend_bar" style=" max-width: 80% ; min-width: 70%;  margin: auto;"></div>    
      <div id="itemName"   style="display:none"><?php echo $_GET["item"];?></div>
<!-- style="display:none"---->
<table id="datatable_yieldTrend"  style="display:none">
    <?php
/*
...
<script type="text/javascript">
    ...
    function y_itemName()
    {
       var  y_name = $.trim($("#itemName").text());
          $("#testT").text(y_name);
       if(y_name==="yield") return "yield(%)";
       else  if(y_name==="retest_ratio") return "retest_ratio(%)";  
       else  if(y_name=="fail") return "failunits
       else   if(y_name==="input") return "input(units)";
       else return '0';
...
$(function () {
 ...
 //   y_itemName();
  ...
  url =  getUrl(item,url);
  createChart(url,'container_YieldTrend_bar');
