...
*/
        var checkDate =  $.trim($("#check_yield").text());
                      ...
                      //  resizable: false,
                       ...
                       // modal: true,
                        ...
                        hide: {
                         ...
                         title: 'Chart of  Yield  Trend(' + dialog_title_yield_trend + ')',
                         position: { my: "center", at: "top", of:  window}
                      });
      
                       $( "#getTrendYield" ).dblclick(function() {
                        ...
                        condition =  condition.toLowerCase();
                       if(condition=="")
                       bar_url_string = "barYieldTrend?time="+time_var+"&item=" + item_var +"&section=FATP";
                      else
                      bar_url_string = "barYieldTrend.php?item=" + item_var +"&"+condition;
                       $("#bar_trend_div_yield").load(bar_url_string);
                      });
              //    }
             ...
             //   html_str += getLegendString(item_var, project_var, section_var, factory_var, line_var, station_var);
                ...
                if ((item_var == "yield") || (item_var.substr(-1, 6) == "_ratio"))
                  ...
                  html_str += "<td style=\"width: 100%;\">";
                     ...
                     title += station_var!=""?station_var.replace(/ /g,"&nbsp;").replace(/&/g,"&")+",":"";
                ...
                $("#chart_trend_yield").html(html_str);
                ...
                yaxis_min_var = (yaxis_min_var == 100) ? 0 : yaxis_min_var;
                  ...
                  chartYield = new Highcharts.Chart({
               // $("#line_trend_div_yield").highcharts({
                  chart: {
                    renderTo: 'line_trend_div_yield',
                    type: 'line'
...
//                        text: unit_str
    ...
    <div id="noData_yield" style="display:none">
        <img src="pic/noData/retestRatio.bmp" title="No Data on <?php echo $_GET["time"]; ?>" />
    </div>
    <div id="chart_trend_yield" style="display:none"></div>
  ...
  <?php 
     ...
     <div id="check_yield"  style="display:none">
    <?php 
