...
/*
   ...
   $(function initTable() {
        var checkDate =  $.trim($("#check_YieldFall").text());
  //$("#testT").text("okok"+checkDate );
        if (checkDate==0)
        {
          $("#noData_YieldFallOut").show(); 
         
        }//check date
        else
        {
          $("#table_YieldFallOut").show(); 
...
*/
          ...
          url_string += "&station=" + formatStationName(station_var);
	        ...
	        $.get(url_string,
                  ...
                  div_str += "</tbody>"
	                ...
	                $("#table_YieldFallOut").html(div_str);
	              ...
	              "text");
                   ...
                   $( "#diago_YieldFallOut" ).dialog({
                    ...
                    $( "#table_YieldFallOut").dblclick(function() {
                         $( "#diago_YieldFallOut" ).dialog( "open" );
                         $("#diago_YieldFallOut_content").load('trend_YieldFallOut_more.php');
                        // $("#ch").text('456');
                         /*
                         var bar_url_string;
                        var condition = $("#conditionBar").text();
   ...
   <!-- <div id="testT"></div>--->
    <div id="noData_YieldFallOut" style="display:none">
        <img src="pic/noData/retestRatio.bmp" title="No Data on <?php echo $_GET["time"]; ?>" />
    </div>
    <div id="table_YieldFallOut"  style="display:none"></div>
  ...
  <?php 
    ...
    <div id="check_YieldFall" style="display:none" >
    <?php 
