...
*/
      ...
      $(function () {
        ...
        var checkDate =  $.trim($("#check_retest").text());
...
/*
  var time_var = $.trim($("#time").text()),
       ...
       var time_var = $.trim($("#time").text()),
        ...
        var condi = $("#getTrendRetestRatio").attr("condi");
       ...
       if(condition=="")
        ...
        var dialog_title_yield_trend = $(".selectTitle").text();
        /*
                      ...
                      //  resizable: false,
                       ...
                       // modal: true,
                        ...
                        hide: {
                         ...
                         title: 'Chart of  Retest Ratio  Trend(' + dialog_title_yield_trend + ')',
                         position: { my: "center", at: "top", of:  window}
                      });

                       $( "#getTrendRetestRatio" ).dblclick(function() {
                         $( "#diago_retestTrend" ).dialog( "open" );
                        ...
                        condition =  condition.toLowerCase();
                        if(condition=="")
                       bar_url_string = "barRetestTrend.php?item=" + item_var +"&section=FATP";
                      else
                      bar_url_string = "barRetestTrend.php?item=" + item_var +"&"+condition;
                     //  $("#testT").text(bar_url_string );
                       $("#diago_retestTrend_Bar").load(bar_url_string);
                      });
        
         //$("#testT").text("okok"+url_string );
       // condi
        /*
        var url_string = "data/trend_full.php?item=" + item_var + "&time=" + time_var + "&project=Panda";
        ...
        $.get(url_string,
             ...
             //   if ((item_var == "yield") || (item_var.substr(-1, 6) == "_ratio"))
                ...
                {
                  html_str += "<img src=\"pic/patterns/arrow_up_red.png\">";
                  up_down = "+";
                }
                ...
                {
                 html_str += "<img src=\"pic/patterns/arrow_down_green.png\">";
                ...
                $("#chart_trend_retestRatio").html(html_str);
   ...
   var   chartRatio = new Highcharts.Chart({
            //    $("#chart_trend_div_input").highcharts({
                  chart: {
                      renderTo:"diago_retestTrend_line",
                    type: 'line'
                   // width: 500,
                   // height: height_var
                  },
...
//                        text: unit_str
    ...
    <body>
    <div id="noData_retest" style="display:none">
        <img src="pic/noData/retestRatio.bmp" title="No Data on <?php echo $_GET["time"]; ?>" />
    </div>
    <div id="chart_trend_retestRatio"  style="display:none"></div>
  ...
  <?php 
    ...
    <div id="check_retest" style="display:none" >
    <?php 
