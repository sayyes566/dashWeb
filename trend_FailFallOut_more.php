...
<html>
    ...
    <div id="mode_sel"></div>
    <h4 id="name_tag"></h4>
    <div id="table_div_failFallOut_More"></div>
...
*/
  var time_var = $.trim($("#time").text()),
      ...
      $("#table_div_failFallOut_More").html(div_str);
...
*/
      if (time_var != "") {
        ...
        condition =  condition.toLowerCase();
          if(condition=="")
            var url_string = "data/dataFail_fallout_more.php?item=" + item_var + "&time=" + time_var+ "&project=" + project_var +"&section=FATP";
       else
            var url_string = "data/dataFail_fallout_more.php?item=" + item_var +"&"+condition;
